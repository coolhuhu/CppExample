...
//   size_t word_size;
//   bool fortran_order;
//   cnpy::parse_npy_header(&buffer_uncompr[0], word_size, shape,
//   fortran_order);
...
//     uint16_t compr_method = *reinterpret_cast<uint16_t *>(&local_header[0] +
//     8); uint32_t compr_bytes = *reinterpret_cast<uint32_t *>(&local_header[0]
//     + 18); uint32_t uncompr_bytes =
...
//   if (!fp) throw std::runtime_error("npz_load: Unable to open file " +
//   fname);
